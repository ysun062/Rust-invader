#![allow(unused)] // silence unused warnings while exploring (to coment out)

use std::collections::HashSet;

use bevy::{prelude::*, math::Vec3Swizzles, sprite::collide_aabb::collide};
use components::{Velocity, Movable, SpriteSize, Laser, FromPlayer, Enemy, ExplosionToSpawn, Explosion, ExplosionTimer, FromEnemy, Player};
...
fn setup_system(mut commands: Commands, asset_server: Res<AssetServer>, mut texture_atlases: ResMut<Assets<TextureAtlas>>, mut windows: ResMut<Windows>){
    //camera
